/* ─────────────────────────────────────────────────────────────
   ...
   1. Guarda la imagen en /public/assets/
   2. Añade el objeto al array products[]
   3. Asigna el categoryId correcto
   ───────────────────────────────────────────────────────────── */
...
export interface Product {
  ...
  categoryId: string;     // tab id: "toxinas" | "voltena" | "rellenos" | "meso"
  image: string;          // /assets/filename.jpg
  presentation: string;
  description: string;
  body?: string;          // short card description
  benefits: string[];
  specs: ProductSpec[];
  badges?: string[];
  tags?: string[];        // short feature chips on the card
  waMessage: string;
  featured?: boolean;
  accentColor: string;    // per-product accent color
  manufacturer?: string;
...
export const products: Product[] = [
  /* ── TOXINAS ─────────────────────────────────────────── */
  {
    ...
    benefits: ["Pureza 98.7% — la más alta del mercado","Resultados visibles en 2-3 días","Vida útil de 36 meses","Triple certificación: FDA · MFDS · CE"],
    ...
    badges: ["98.7% Pureza", "FDA", "MFDS", "CE", "36m"],
    tags: ["Pureza 98.7%", "Larga duración", "Neurotoxina pura", "Resultados naturales"],
  ...
  },
  {
    ...
    description: "Primera toxina botulínica tipo A del mundo en formato líquido lista para usar. Sin albúmina sérica humana.",
    ...
    benefits: ["Sin dilución necesaria","Sin albúmina animal","Almacenamiento a temperatura ambiente","Vida útil de 36 meses"],
    ...
    tags: ["Sin dilución", "Sin albúmina animal", "T. Ambiente", "36 meses vida útil"],
  ...
  },
  {
    ...
    tags: ["Pureza 99.8%", "2-8°C", "Alta precisión", "36 meses"],
  ...
  /* ── VOLTENA ──────────────────────────────────────────── */
  {
    ...
    description: "Suero inyectable con ingredientes naturales activos que disuelve la grasa localizada. Alternativa segura, sin cicatrices y con efectos a largo plazo.",
    ...
    benefits: ["Disuelve grasa localizada sin cirugía","Sin cicatrices — mínimamente invasivo","Efectos visibles y duraderos","Facial & corporal"],
    ...
    tags: ["Disuelve grasa", "Sin cicatrices", "Facial & corporal", "Lipo-contouring"],
  ...
  },
  {
    ...
    presentation: "60cc",
    description: "Relleno corporal de ácido hialurónico de alta densidad para mejorar volumen y contornear áreas amplias de forma no quirúrgica.",
    ...
    benefits: ["HA corporal de alta densidad","No quirúrgico — sin recuperación","Gran volumen y contorneo","Resultados naturales e inmediatos"],
    ...
    tags: ["HA corporal", "No quirúrgico", "Gran volumen", "Contorneo"],
  ...
  },
  {
    ...
    presentation: "300g",
    description: "Fórmula avanzada con 17 aminoácidos — treonina, metionina y más. Nutre, reafirma la piel y actúa contra la grasa localizada y celulitis.",
    ...
    benefits: ["17 aminoácidos activos (treonina, metionina)","Reafirma y nutre la dermis","Combate grasa y celulitis","Compatible con rodillo de masaje"],
    ...
    tags: ["17 aminoácidos", "Anticelulítico", "Gel frío", "Lipo-reducción"],
  ...
  /* ── RELLENOS ─────────────────────────────────────────── */
  {
    ...
    description: "HA de alta pureza con lidocaína para mayor comodidad. Ideal para eliminación de pliegues nasolabiales, aumento de labios y remodelación facial.",
    ...
    badges: ["Monofásico", "Lidocaína", "CE", "Alta Pureza"],
    tags: ["HA 24mg/ml", "Lidocaína 0.3%", "Pliegues profundos", "Aumento labios"],
  ...
  },
  {
    ...
    description: "Tecnología de reticulación 3D con altas propiedades volumétricas. HA de origen no animal, minimizando reacciones alérgicas.",
    ...
    benefits: ["Tecnología de reticulación PNET 3D","Alta elasticidad y cohesividad","Mínima presencia de BDDE residual","Doble jeringa por empaque"],
    ...
    badges: ["PNET Tech", "Volumen", "KFDA"],
    tags: ["Reticulación 3D", "No animal", "Alta volumetría", "Biodegradación resistente"],
  ...
  },
  {
    ...
    description: "La línea de rellenos más reconocida mundialmente. Tecnología VYCROSS para resultados naturales y duraderos en labios, mejillas y contorno facial.",
    ...
    benefits: ["Tecnología VYCROSS exclusiva","Resultados naturales y duraderos","Múltiples densidades disponibles","Aprobada FDA para todas las indicaciones"],
    ...
    tags: ["VYCROSS tech", "Volbella", "Voluma", "Volux"],
  ...
  },
  {
    ...
    description: "Relleno de HA de alta pureza con mínimo riesgo de rechazo. Tres densidades para arrugas superficiales, labios, pómulos y contorno mandibular.",
    ...
    tags: ["HA alta pureza", "Bajo rechazo", "12-18 meses", "Moldeable"],
  ...
  /* ── MESOTERAPIA & OTROS ──────────────────────────────── */
  {
    ...
    description: "Formulado con polinucleótidos derivados del ADN de salmón. Diseñado para la revitalización del área periorbital. Mejora ojeras y regenera la piel.",
    ...
    benefits: ["Polinucleótidos de ADN de salmón","Regeneración profunda del área periorbital","Mejora ojeras y líneas finas","Alta biocompatibilidad"],
    ...
    tags: ["ADN de salmón", "Área periorbital", "Ojeras", "Regeneración celular"],
  ...
  },
  {
    ...
    description: "Skinbooster de hialuronato de sodio que proporciona hidratación intensa. Estimula colágeno y elastina. Compatible con Hyaluron Pen.",
    ...
    benefits: ["Hialuronato de sodio 25mg/2.5ml","Estimula colágeno & elastina","Compatible con Hyaluron Pen","Hidratación profunda duradera"],
    ...
    tags: ["Skinbooster", "Colágeno & elastina", "Micro-inyecciones", "Hidratación profunda"],
  ...
  },
  {
    ...
    body: "Crema anestésica tópica a base de lidocaína para adormecer la piel antes de procedimientos estéticos como inyecciones, microneedling o láser.",
    benefits: ["Lidocaína 10.56% — alta potencia","Acción rápida en 20-30 minutos","Ideal pre-procedimiento","Presentación en 500g económica"],
    ...
    tags: ["Lidocaína 10.56%", "Tópica", "Pre-procedimiento", "Acción rápida"],
  ...
  },
  {
    ...
    description: "Hialuronidasa que disuelve el ácido hialurónico sintético. Esencial para corregir resultados no deseados de rellenos dérmicos.",
    ...
    tags: ["Disuelve HA", "Corrección rellenos", "Enzima natural", "Emergencias"],
